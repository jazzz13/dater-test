...
exports.checkTypeParam = (value: any, type: string, name: string) => {
  if (!value || (typeof value !== type)) { // eslint-disable-line valid-typeof
...
exports.httpMethodsWrap = (method: Function) => async (req, res) => {
  try {
